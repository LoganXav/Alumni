                ...
                <Splide options = {splideOptions}>
                    ...
                    <SplideSlide key={student.id} className="sm:max-w-full md:w-full md:h-[500px] p-2 bg-transparent sm:h-[200px] cursor-pointer group">
                       <Link to= {`/students/${student.id}`} >
                            <div className=" sm:w-full rounded-md shadow-md shadow-gray-500 overflow-hidden md:w-auto relative sm:bg-transparent md:bg-black z-2 h-full duration-500 hover:transform sm:hover:translate-y-[-15px] md:hover:translate-y-[-60px] hover:transition-all hover:ease-in-out hover:duration-1000">
